...
namespace FresherMisa2026.Application.Interfaces.Services
{
    public interface IEmployeeService : IBaseService<Employee>
    {
        ...
        /// <returns></returns>
        Task<ServiceResponse> GetEmployeeByCodeAsync(string code);
        /// <summary>
        /// lấy ds nhân viên theo id phòng ban
        /// </summary>
        /// <param name="departmentId"></param>
        /// <returns></returns>
        Task<ServiceResponse> GetEmployeesByDepartmentIdAsync(Guid departmentId);
        /// <summary>
        /// lấy ds nhân viên theo id vị trí
        /// </summary>
        /// <param name="positionId"></param>
        /// <returns></returns>
        Task<ServiceResponse> GetEmployeesByPositionIdAsync(Guid positionId);
        /// <summary>
